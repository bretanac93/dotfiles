...
tdl() {
  ...
  # Select the editor pane for focus. (Upstream targets $opencode_pane here,
  # which tdl never sets — that resolves to an empty target and leaves focus
  # wherever the last split put it.)
